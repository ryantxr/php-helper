...
class ArrayHelper
{
    ...
    function append_config(array $array)
    {
        ...
        foreach ($array as $key => $value) {
            if (is_numeric($key)) {
                $start++;
                $array[$start] = self::array_pull($array, $key);
            }
        }
        return $array;
    }
    ...
    function array_flatten($array, $depth = INF)
    {
        ...
        foreach ($array as $item) {
            if (! is_array($item)) {
                ...
                $result = array_merge($result, self::array_flatten($item, $depth - 1));
            }
        }
        return $result;
    }
    ...
    function array_forget(&$array, $keys)
    {
        ...
        foreach ($keys as $key) {
            ...
            if (self::array_exists($array, $key)) {
                unset($array[$key]);
                continue;
            }
            $parts = explode('.', $key);
    ...
    function array_get($array, $key, $default = null)
    {
        ...
        foreach (explode('.', $key) as $segment) {
            if (self::array_accessible($array) && self::array_exists($array, $segment)) {
                $array = $array[$segment];
            } else {
                return self::value($default);
            }
    ...
    function array_has($array, $keys)
    {
        ...
        foreach ($keys as $key) {
            ...
            foreach (explode('.', $key) as $segment) {
                if (self::array_accessible($subKeyArray) && self::array_exists($subKeyArray, $segment)) {
    ...
    function data_get($target, $key, $default = null)
    {
        ...
        while (! is_null($segment = array_shift($key))) {
            ...
            if (self::array_accessible($target) && self::array_exists($target, $segment)) {
    ...
    function array_sort_recursive($array)
    {
        foreach ($array as &$value) {
            if (is_array($value)) {
                $value = self::array_sort_recursive($value);
            }
        }
        if (self::isAssoc($array)) {
            ksort($array);
